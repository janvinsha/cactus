...
import { PluginLedgerConnectorHedera } from "../plugin-ledger-connector-hedera";
...
export interface IRunTransactionEndpointOptions {
  ...
  connector: PluginLedgerConnectorHedera;
}
...
export class RunTransactionEndpoint implements IWebServiceEndpoint {
  ...
  public get oasPath(): typeof OAS.paths["/api/v1/plugins/@hyperledger/cactus-plugin-ledger-connector-hedera/run-transaction"] {
    return OAS.paths[
